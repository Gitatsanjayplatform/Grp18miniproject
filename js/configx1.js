...
let car =0
      document.querySelectorAll('input[name="engineoptionradio"]').forEach((radio) => {
        if (radio.checked) {
          ...
          if (engineOption === "X1 sDrive18i xLine") {
            car = 4590000;
            engineamount = 0;
          } else if (engineOption === "X1 sDrive18i M Sport") {
            engineamount = 300000;
            car = 4890000;
          } else if (engineOption === "X1 sDrive18d M Sport") {
            engineamount = 570000;
             car= 5160000;
          }
      ...
      const caramount = 4590000 + chargeamount;
  ...
  function updatePrice() {
    ...
    radioButtons1.forEach((radioButton) => {
      if (radioButton.checked) {
        if (radioButton.value === "X1 sDrive18i M Sport") {
          engine1.style.display = "none";
          engine2.style.display = "block";
          engine3.style.display = "none";
          enginename = "X1 sDrive18i M Sport";
          engineamount = 300000;
        } else if (radioButton.value === "X1 sDrive18d M Sport") {
          engine1.style.display = "none";
          engine2.style.display = "none";
          engine3.style.display = "block";
          enginename = "X1 sDrive18d M Sport";
          engineamount = 570000;
        } else if (radioButton.value === "X1 sDrive18i xLine") {
          engine1.style.display = "block";
          engine2.style.display = "none";
          engine3.style.display = "none";
          enginename = "X1 sDrive18i xLine";
          engineamount = 0;
        }
      }
    });
