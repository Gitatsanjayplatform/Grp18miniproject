...
let car =0
      document.querySelectorAll('input[name="engineoptionradio"]').forEach((radio) => {
        if (radio.checked) {
          ...
          if (engineOption === "X7 xDrive40i M Sport") {
            car = 12370000;
            engineamount = 0;
          } else if (engineOption === "X7 xDrive40d M Sport") {
            engineamount = 250000;
            car = 12620000;}
      ...
      const caramount = 12370000 + chargeamount;
  ...
  function updatePrice() {
    ...
    radioButtons1.forEach((radioButton) => {
      if (radioButton.checked) {
        if (radioButton.value === "X7 xDrive40d M Sport") {
          engine1.style.display = "none";
          engine2.style.display = "block";
          // engine3.style.display = "none";
          enginename = "X7 xDrive40d M Sport";
          engineamount = 250000;
        } 
        else if (radioButton.value === "X7 xDrive40i M Sport") {
          engine1.style.display = "block";
          engine2.style.display = "none";
          // engine3.style.display = "none";
          enginename = "X7 xDrive40i M Sport";
          engineamount = 0;
        }
        // else
        //  if (radioButton.value === "X3 xDrive20d M Sport") {
        //   engine1.style.display = "none";
        //   engine2.style.display = "none";
