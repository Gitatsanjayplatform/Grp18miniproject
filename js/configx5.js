...
let car =0
      document.querySelectorAll('input[name="engineoptionradio"]').forEach((radio) => {
        if (radio.checked) {
          ...
          if (engineOption === "X5 xDrive40i xLine") {
            car = 9520000;
            engineamount = 0;
          } else if (engineOption === "X5 xDrive40i M Sport") {
            engineamount = 1120000;
            car = 10640000;
          } else if (engineOption === "X5 xDrive30d M Sport") {
            engineamount = 1320000;
             car= 10840000;
          }
      ...
      const caramount = 9520000 + chargeamount;
  ...
  function updatePrice() {
    ...
    radioButtons1.forEach((radioButton) => {
      if (radioButton.checked) {
        if (radioButton.value === "X5 xDrive40i M Sport") {
          engine1.style.display = "none";
          engine2.style.display = "block";
          engine3.style.display = "none";
          enginename = "X5 xDrive40i M Sport";
          engineamount = 1120000;
        } else if (radioButton.value === "X5 xDrive30d M Sport") {
          engine1.style.display = "none";
          engine2.style.display = "none";
          engine3.style.display = "block";
          enginename = "X5 xDrive30d M Sport";
          engineamount = 1320000;
        } else if (radioButton.value === "X5 xDrive40i xLine") {
          engine1.style.display = "block";
          engine2.style.display = "none";
          engine3.style.display = "none";
          enginename = "X5 xDrive40i xLine";
          engineamount = 0;
        }
      }
    });
