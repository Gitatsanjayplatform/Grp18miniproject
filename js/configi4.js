...
let car =0
      document.querySelectorAll('input[name="engineoptionradio"]').forEach((radio) => {
        if (radio.checked) {
          ...
          if (engineOption === "i4 eDrive35 M Sport") {
            car = 7250000;
            engineamount = 0;
          } else if (engineOption === "i4 eDrive40 M Sport") {
            engineamount = 500000;
            car = 7750000;
          } 
      ...
      const caramount = 7250000 + chargeamount;
  ...
  function updatePrice() {
    ...
    radioButtons1.forEach((radioButton) => {
      if (radioButton.checked) {
        if (radioButton.value === "i4 eDrive40 M Sport") {
          engine1.style.display = "none";
          engine2.style.display = "block";
          // engine3.style.display = "none";
          enginename = "i4 eDrive40 M Sport";
          engineamount = 500000;
        } 
        else if (radioButton.value === "i4 eDrive35 M Sport") {
         engine1.style.display = "block";
         engine2.style.display = "none";
         // engine3.style.display = "none";
         enginename = "i4 eDrive35 M Sport";
         engineamount = 0;
       }
        // else
