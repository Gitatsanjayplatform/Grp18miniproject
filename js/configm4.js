...
let car =0
      document.querySelectorAll('input[name="engineoptionradio"]').forEach((radio) => {
        if (radio.checked) {
          ...
          if (engineOption === "M4 Competition M xDrive") {
            car = 14750000;
            engineamount = 0;
          } 
      ...
      const caramount = 14750000 + chargeamount;
  ...
  function updatePrice() {
    ...
    radioButtons1.forEach((radioButton) => {
      if (radioButton.checked) {
        ...
        //   engineamount = 340000;
        // } else 
        if (radioButton.value === "M4 Competition M xDrive") {
          engine1.style.display = "block";
          // engine2.style.display = "none";
          // engine3.style.display = "none";
          enginename = "M4 Competition M xDrive";
          engineamount = 0;
        }
      }
    });
