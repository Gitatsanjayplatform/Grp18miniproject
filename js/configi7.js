...
let car =0
      document.querySelectorAll('input[name="engineoptionradio"]').forEach((radio) => {
        if (radio.checked) {
          ...
          if (engineOption === "i7 xDrive60 M Sport") {
            car = 20300000;
            engineamount = 0;
          } 
...
;
    ...
    radioButtons1.forEach((radioButton) => {
      if (radioButton.checked) {
        ...
        //   engineamount = 340000;
        // } else 
        if (radioButton.value === "i7 xDrive60 M Sport") {
          engine1.style.display = "block";
          // engine2.style.display = "none";
          // engine3.style.display = "none";
          enginename = "i7 xDrive60 M Sport";
          engineamount = 0;
        }
      }
    });
